...
| Network | Destination      |    Next Hop   | Metric |
|---------|------------------|---------------|:------:|
| `O1`    | `10.0.98.0/27`   | `10.0.98.177` | 1      |
|         | `10.0.98.0/27`   | `10.0.98.186` | 5      |
...
| Network | Destination      |    Next Hop   | Metric |
|---------|------------------|---------------|:------:|
| `O1`    | `10.0.98.0/27`   | `10.0.98.182` | 1      |
|         | `10.0.98.0/27`   | `10.0.98.185` | 5      |
| `O2`    | `10.0.98.128/28` | `10.0.98.185` | 1      |
|         | `10.0.98.128/28` | `10.0.98.182` | 5      |
